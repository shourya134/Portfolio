...
'Took an innovative approach and used machine learning techniques of PyAudioAnalysis and Pydub python libraries to convert audio files into transcripts making the process 10 times faster',
